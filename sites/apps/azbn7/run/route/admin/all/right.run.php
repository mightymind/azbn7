...
$query = $this->Azbn7->mdl('DB')->q("SELECT SQL_CALC_FOUND_ROWS * FROM `" . $this->Azbn7->mdl('DB')->t['right'] . "` WHERE 1 ORDER BY uid ASC LIMIT " . $start_at . ", " . $this->Azbn7->config['pagination']['count']);
if($query) {
